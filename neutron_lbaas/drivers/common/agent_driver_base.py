...
AGENT_SCHEDULER_OPTS = [
    ...
    cfg.BoolOpt('allow_automatic_lbaas_agent_failover',
                ...
                help=_('Automatically reschedule loadbalancer from offline '
                       'lbaas agents to online lbaas agents.')),
]
...
class LoadBalancerManager(driver_base.BaseLoadBalancerManager,
    ...
    def __init__(self, driver):
        ...
        self.start_periodic_lbaas_agent_status_check()

    def start_periodic_lbaas_agent_status_check(self):
        if not cfg.CONF.allow_automatic_lbaas_agent_failover:
            LOG.info(_LI("Skipping period LbaaS agent status check because "
                         "automatic loadbalancer rescheduling is disabled."))
            return
